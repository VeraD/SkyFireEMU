...
UPDATE `creature_template` SET `unit_flags`=0x2|0x4|0x20000|0x2000000, `faction_a`=24, `faction_h`=24, `AIName`='SmartAI' WHERE `entry`=88747; -- Wild mushroom
...
DELETE FROM `smart_scripts` WHERE `entryorguid` IN (43497,43484,88747);
...
(88747,0,0,0,100,0,60,6000,6000,1000,1000,47,0,0,1,0,'Wild mushroom invisibility'); -- SMART_EVENT_UPDATE & SMART_ACTION_SET_VISIBILITY & SMART_TARGET_SELF // Devrait utiliser un sort ?

DELETE FROM `spell_bonus_data` WHERE `entry`=88751;
INSERT INTO `spell_bonus_data` (`entry`,`direct_bonus`,`comments`) VALUE (88751,0.65,'Druid: Wild mushroom damage');
